...
{           
	...
	DACCTRL1L = 0x83; //CLKDIV 1:1; DACON disabled; DACSIDL disabled; FCLKDIV 1:4; CLKSEL AFPLLO - Auxiliary Clock with PLL Enabled ; 
	DACCTRL2L = 0x55; //TMODTIME 85; 
	DACCTRL2H = 0x8A; //SSTIME 138; 
	DAC1CONH = 0x00; //TMCB 0; 
	DAC1CONL = 0xA00A; //CMPPOL Non Inverted; HYSPOL Rising Edge; HYSSEL 30mV; DACEN enabled; FLTREN disabled; CBE disabled; IRQM Rising edge detect; INSEL CMP1B; DACOEN disabled; 
